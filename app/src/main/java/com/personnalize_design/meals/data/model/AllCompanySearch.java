...
public class AllCompanySearch {
    ...
    public static class CompanyData {
        ...
        private List<CompanyWorkinDayBean> companyWorkinDay;
        ...
        public List<CompanyWorkinDayBean> getCompanyWorkinDay() {
            return companyWorkinDay;
        }

        public void setCompanyWorkinDay(List<CompanyWorkinDayBean> companyWorkinDay) {
